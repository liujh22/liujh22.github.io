...
\PassOptionsToPackage{style=ieee,sorting=ydnt,uniquename=init,defernumbers=true,maxbibnames=99}{biblatex}
...
\DeclareFieldFormat{pubstate}{\mkbibbold{\ifbibstring{#1}{\bibstring{#1}}{#1}}}
...
\newlength{\contactleftcolwidth}
\setlength{\contactleftcolwidth}{\dimexpr22em-2cm\relax}
...
\leftheader{%
  ...
  \makebox[\contactleftcolwidth][l]{\makefield{\faEnvelope[regular]}{\href{mailto:ntd9kz@virginia.edu}{\texttt{ntd9kz@virginia.edu}}}}%
  \makefield{\raisebox{0.12ex}{\faPhone}}{\texttt{+1 929-689-5869}}\\
  \makebox[\contactleftcolwidth][l]{\makefield{\faGlobe}{\href{https://liujh22.github.io/}{\texttt{liujh22.github.io}}}}%
  \makefield{\raisebox{0.12ex}{\faMapMarker}}{\texttt{485 McCormick Rd, Charlottesville, VA 22904}}
...
\input{publications}
\makerubric{talks_presentations}
