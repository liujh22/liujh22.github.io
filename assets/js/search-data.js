...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Publications",
          description: "Publications and preprints by Jiahuan Liu on neuroscience, visual processing, balance, and locomotor behavior.",
          section: "Navigation",
          handler: () => {
        ...
        },{id: "news-my-blog-goes-online-today",
          title: 'My blog goes online today! 😄',
          description: "",
          section: "News",},{id: "news-added-function-to-generate-and-update-cv-automatically",
          title: 'Added function to generate and update CV automatically.',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/liujh22", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
